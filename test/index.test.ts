...
describe("Test the basic usage of video", () => {
	...
	test("Double-colon & mp4-only ver. of video with the title attribute", async () => {
		const input = "::video[Title value]{src=/videos/sample-video-1.mp4}";
		const output = `
    <div title="Title value" data-remark-video-figure>
      <video controls preload="metadata" width="100%">
        <source src="${BASE_URL}/videos/sample-video-1.mp4" type="video/mp4">
      </video>
    </div>
  ...
  :::
	...
	test("Triple-colon & mp4-only ver. of video with the title attribute", async () => {
		const input = `
  :::video[Title value]
  /videos/sample-video-1.mp4
  :::
    ...
    <div data-remark-video-figure>
      <video controls preload="metadata" width="100%">
        ...
        <source src="${BASE_URL}/videos/sample-video-3.mp4" type="video/mp4">
      </video>
    </div>
    `;
    ...
    <div data-remark-video-figure>
      <video controls preload="metadata" width="100%">
        <source src="${BASE_URL}/videos/sample-video-1.mp4" type="video/mp4">
				<p class="fallback-content">Your browser does not support the video tag.</p>
      </video>
    </div>
    `;
